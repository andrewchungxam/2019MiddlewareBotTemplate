...
namespace MiddlewareBot
{
    ...
    /// </summary>
    public class TranslationMiddleware3 : IMiddleware
    {
        public TranslationMiddleware3()
        {
...
//        public TranslationMiddleware3()//(MicrosoftTranslator translator, UserState userState)
//        {
